...
products_df2 = spark.read.csv(path=products_csv_path,header=True,schema=user_defined_schema)
...
products_df3 = spark.read.csv(path=products_csv_path,header=True,schema=ddl_schema)
