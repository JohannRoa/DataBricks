...
# DBTITLE 0,--i18n-d56869f0-d544-4361-bd46-0a821ec8acb5
# MAGIC %md
# MAGIC
# MAGIC
# MAGIC
...
# MAGIC 1. In the pop-up window, you may not see the message **Create new destinations in Alert Destinations**.
# MAGIC 1. If you don't have workspace `administrator privileges`. If you don't see the message, proceed to the next step.
