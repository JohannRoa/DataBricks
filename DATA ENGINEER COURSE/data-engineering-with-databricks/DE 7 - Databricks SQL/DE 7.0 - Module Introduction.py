...
# MAGIC
# MAGIC #### Lessons
# MAGIC [DE 7.1 - Follow Along Demo - Navigating Databricks SQL and Attaching to Warehouses]($./DE 7.1 - Follow Along Demo - Navigating Databricks SQL and Attaching to Warehouses) <br>
# MAGIC [DE 7.2L - Last Mile ETL with DBSQL Lab]($./DE 7.2L - Last Mile ETL with DBSQL Lab) <br>
# MAGIC
# MAGIC #### Prerequisites
